...
use board::Board;
use strategy::continent::Continent;
...
impl Strategy {
    pub fn new(board: Board) -> Strategy {
...
mod tests {
    ...
    fn it_should_init_correctly() {
        ...
        map.link_cells(2, 1);
        map.link_cells(1, 0);
        let mut strategy = Strategy::new(map);
    ...
    fn it_should_collect_stats_correctly() {
        ...
        let mut strategy = Strategy::new(board);
        {
